...
export default function TutorBadgesScreen() {
  ...
  const loadBadges = async () => {
    try {
      ...
      // Filter to show tutor-relevant badges
      const tutorBadges = badgesRes.data.filter(
        b => b.category === 'TUTOR' || b.category === 'BOTH'
      );

      setBadges(tutorBadges);
            ...
            <View style={styles.statsHeader}>
              ...
              <View style={styles.statsContent}>
                ...
                <Text style={styles.statsSubtitle}>
                  {statistics.earnedBadges} sur {badges.length} badges
                </Text>
              </View>
            </View>
              ...
              <View style={styles.progressBarBackground}>
                <View
                  style={[
                    ...
                    {
                      width: `${badges.length > 0 ? (statistics.earnedBadges / badges.length) * 100 : 0}%`,
                    },
                  ]}
                />
              </View>
              <Text style={styles.progressText}>
                {badges.length > 0 ? Math.round((statistics.earnedBadges / badges.length) * 100) : 0}%
              </Text>
            </View>
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  router.push(`/(tutor)/badges/${badge.id}` as any);
                }}
              >
                <View
                  style={[
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateText}>
              {selectedFilter === 'earned'
                ? "Vous n'avez pas encore obtenu de badges. Continuez à donner des cours pour en gagner!"
