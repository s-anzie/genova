        ...
        <View style={[styles.currentPlanCard, isFreeTier ? styles.freePlanCard : styles.premiumPlanCard]}>
          ...
          <View style={styles.featuresContainer}>
            ...
            <View style={styles.featureItem}>
              ...
              <Text style={[styles.featureText, !status?.features?.examBankAccess && styles.featureTextDisabled]}>
                Banque d'épreuves
              </Text>
            </View>
            ...
            <View style={styles.featureItem}>
              ...
              <Text style={[styles.featureText, !status?.features?.prioritySupport && styles.featureTextDisabled]}>
                Support prioritaire
              </Text>
            </View>
