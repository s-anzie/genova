...
const COUNTRIES = [
  ...
  { label: 'Chine', value: 'CN', flag: '🇨🇳' },
  { label: 'Corée', value: 'KR', flag: '🇰🇷' },
  { label: 'Japon', value: 'JP', flag: '🇯🇵' },
  { label: 'Allemagne', value: 'DE', flag: '🇩🇪' },
  { label: 'Espagne', value: 'ES', flag: '🇪🇸' },
  { label: 'Italie', value: 'IT', flag: '🇮🇹' },
];
                  ...
                  return (
                    ...
                    >
                      <View style={styles.countryLeft}>
                        ...
                        <Text style={[styles.countryLabel, isSelected && styles.countryLabelActive]}>
                          {country.label}
                        </Text>
                      </View>
                      {isSelected && (
                        <View style={styles.checkIconRound}>
                          <Check size={14} color={Colors.white} strokeWidth={3} />
                        </View>
                      )}
                    </TouchableOpacity>
