        ...
        {!badge.earned && (
          <View style={styles.tipsCard}>
            ...
            <Text style={styles.tipsText}>
              {badge.name === 'Assidu' &&
                'Assurez-vous de vous enregistrer à toutes vos sessions pour maintenir un taux de présence élevé.'}
              {badge.name === 'Mentor' &&
              ...
              {badge.name === 'Progressiste' &&
                'Enregistrez régulièrement vos résultats académiques pour suivre vos progrès.'}
