...
export default function SearchScreen() {
  ...
  }), [params.rating, params.educationLevels, params.subjects, params.teachingMode, params.gender]);
  ...
  }, [filters.rating, filters.educationLevels, filters.subjects, filters.teachingMode, filters.gender]);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchSection}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/(student)/search/filters')}
        >
      ...
      {/* Filter Tags */}
      {(filters.rating || filters.educationLevels.length > 0 || filters.subjects.length > 0 || filters.teachingMode || filters.gender) && (
